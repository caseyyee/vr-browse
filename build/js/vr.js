...
var mouseMaxY = 240;  // max deg movement in X direction of mouse.
...
function frameCallback() {
  ...
  if (mouseLook) {
    if (vrSensor) {
      cssCamera.style.transform = 'translate3d(0, 0, 0) rotateX('+mouseDegX*-1+'deg) rotateY('+mouseDegY+'deg) rotateZ(180deg)';
    } else {
...
function onmousemove(e) {
  if (mouseLook) {
    mouseDegY = (e.clientX - (clientWidth/2))/(clientWidth/2/mouseMaxY);
